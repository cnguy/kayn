...
class Kayn {
    constructor(
        ...
        this.Static = {
            ...
            ReforgedRunePaths: new StaticReforgedRunePathsEndpoint(this.config, this.limiter),
            ReforgedRunes: new StaticReforgedRunesEndpoint(this.config, this.limiter),
            Rune: new StaticRuneEndpoint(this.config, this.limiter),
            SummonerSpell: new StaticSummonerSpellEndpoint(
                this.config,
                this.limiter,
            ),
            TarballLinks: new StaticTarballLinksEndpoint(this.config, this.limiter),
