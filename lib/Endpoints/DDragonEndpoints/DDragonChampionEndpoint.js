...
class DDragonChampionEndpoint {
    constructor(config) {
        ...
        this.Helpers = {
            ...
            listDataById: this.listDataById.bind(this),
            listDataByIdWithParentAsId: this.listDataByIdWithParentAsId.bind(
                this,
            ),
            listFullDataById: this.listFullDataById.bind(this),
            listFullDataByIdWithParentAsId: this.listFullDataByIdWithParentAsId.bind(
                this,
            ),
        }
    }
