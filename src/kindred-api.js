    ...
    if (limits) {
      ...
      Object.keys(REGIONS).map(region => {
        this.methodLimits[REGIONS[region]] = {
          ...
          [METHOD_TYPES.LIST_CHAMPIONS]: new RateLimit(400, 60),
          [METHOD_TYPES.GET_CHAMPION]: new RateLimit(400, 60),
          ...
          [METHOD_TYPES.GET_MASTERY_PAGES]: new RateLimit(400, 60),
          ...
          [METHOD_TYPES.GET_RUNE_PAGES]: new RateLimit(400, 60),
